...
import { ERROR_CREATING_USER, ERROR_HASHING_PASSWORD, ERROR_VERIFING_USER, USER_CREATED_SUCCESSFULLY, USER_NOT_FOUND } from "../helper/constants";
...
class UserController {
  ...
  hashPassword = async (password: string): Promise<string> => {
      console.log('hashedPassword password: ', password)
      try {
